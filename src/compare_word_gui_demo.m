function compare_word_gui_demo(unique_words, genres, percent_mat)
...
% genre{j}.
%
% NOTE: THIS IS THE DEMO VERSION OF THIS FUNCTION. THIS IS ONLY USED FOR
% DEMONSTRATING THE USE OF compare_word_gui() IN full_execution_demo.m.
% PLEASE USE compare_word_gui() instead.
...
%DEMO CODE: Usually this code would be inside of callbackfn
demo_word_to_compare = 'baby';

set(huitext, 'String', demo_word_to_compare); %DEMO CODE

word = get(huitext, 'String'); %get string "user" entered
